...
$url="https://api.opencagedata.com/geocode/v1/json?q=" . $_REQUEST["param1"] . "+" . $_REQUEST["param2"] . "&key=777f761e5746414697e69cbf97b96341";
...
$output["data"] = $decode["results"]["0"]["formatted"];
